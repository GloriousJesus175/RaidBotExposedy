...
namespace Exposed
{
    class Program
    {
        ...
        {
            _ = AnimateTitleLoop("Developed By. Exposed Dev's Team");
            ...
            Console.Clear();
            // Banner Verde (pasted_content.txt)
            ...
            // Banner Vermelho (Exposed Society)
            Console.ForegroundColor = ConsoleColor.DarkRed;
            Console.WriteLine(@"oooooooooooo                                                           .o8        .oooooo..o                      o8o                .               ");
            Console.WriteLine(@"`888'     `8                                                          ""888       d8P'    `Y8                      `""'              .o8               ");
            Console.WriteLine(@" 888         oooo    ooo oo.ooooo.   .ooooo.   .oooo.o  .ooooo.   .oooo888       Y88bo.       .ooooo.   .ooooo.  oooo   .ooooo.  .o888oo oooo    ooo ");
            Console.WriteLine(@" 888oooo8     `88b..8P'   888' `88b d88' `88b d88(  ""8 d88' `88b d88' `888        `""Y8888o.  d88' `88b d88' `""Y8 `888  d88' `88b   888    `88.  .8'  ");
            Console.WriteLine(@" 888    ""       Y888'     888   888 888   888 `""Y88b.  888ooo888 888   888            `""Y88b 888   888 888        888  888ooo888   888     `88..8'   ");
            Console.WriteLine(@" 888       o  .o8""'88b    888   888 888   888 o.  )88b 888    .o 888   888       oo     .d8P 888   888 888   .o8  888  888    .o   888 .    `888'    ");
            Console.WriteLine(@"o888ooooood8 o88'   888o  888bod8P' `Y8bod8P' 8""""888P' `Y8bod8P' `Y8bod88P""      8""""88888P'  `Y8bod8P' `Y8bod8P' o888o `Y8bod8P'   ""888""     .8'     ");
            Console.WriteLine(@"                          888                                                                                                            .o..P'      ");
            Console.WriteLine(@"                         o888o                                                                                                           `Y8P'       ");
            Console.WriteLine("                                                                       ");
            Console.WriteLine("                                                                       ");
            Console.ForegroundColor = ConsoleColor.Gray;
            Console.WriteLine("                                        By. Glorious");
               ...
               bool guildValid = false;
                while (!guildValid)
                {
                    ...
                    if (!await IsBotInGuild())
                    {
                        ...
                        Console.ResetColor();
                        await Task.Delay(2000);
                        continue; // Pede o Guild ID de novo sem resetar o Token
                    }
                    guildValid = true;
                }
                ...
                if (userInfo is not null)
                {
                    ...
                    break; // Sai do loop do Token
                }
                else
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("❌ Failed to retrieve bot information.");
                    Console.ResetColor();
                    return;
                }
            }
        ...
        static async Task BotIsAwake()
        {
            ...
            while (true)
            {
                try
                {
                    await socketClient.SetGameAsync("𒈙BY-EXPOSED-DEV'S𒈙", null, ActivityType.Playing);
                }
                catch {}
        ...
        static void ShowMenu()
        {
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine($"                                      Conectado No Bot: [{botUsername}]");
            ...
            Console.ForegroundColor = ConsoleColor.Green;
            Console.WriteLine("                          ┌───────═══════════───────┬────────═══════════──────┐");
            Console.WriteLine("                          ║       Version: 0.0.1    ║        By. Exposed      ║");
            Console.WriteLine("                          └──────═════─┬─═════──────┴───────═════─┬─═════─────┘");
            Console.WriteLine("                         ┌─────────────┴──────────────────────────┴────────────┐");
            Console.WriteLine("           ╔─────────────┴─────────────╦──────────────────────────╦────────────┴────────────╗");
